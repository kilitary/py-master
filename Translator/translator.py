...
def translate():
    ...
    translation = translator.translate(var5.get())
...
var3 = StringVar()
textbox = Entry(mainframe, textvariable=var3).grid(row=1, column=1, padx=10, pady=10)

Label(mainframe, text="Enter a language to").grid(row=0, column=2)
var4 = StringVar()
textbox = Entry(mainframe, textvariable=var4).grid(row=1, column=2, padx=10, pady=10)

# Text Box to take user input
Label(mainframe, text="Enter text").grid(row=3, column=0)
var5 = StringVar()
textbox = Entry(mainframe, textvariable=var5).grid(row=3, column=1)
